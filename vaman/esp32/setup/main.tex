...
\item Make connections as shown in \tabref{tab:arduino-uart}.
...
\item Connect the pins between Vaman-ESP32 and Vaman-PYGMY as per \tabref{tab:vaman/esp32/setup/onboard}
\begin{table}[h]
\centering
